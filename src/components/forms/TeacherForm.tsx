...
const TeacherForm = ({
  ...
  if (msg.includes("email") || msg.includes("Email")) {
    ...
    setServerError("Password is too common or found in a data breach. Use a stronger password (e.g. SchooLama@2024#X).");
  } else {
  ...
  return (
    <div className="flex flex-col h-full max-h-[85vh]">
      ...
      <div className="overflow-y-auto flex-1 py-4 pr-1">
        <form className="flex flex-col gap-6" onSubmit={onSubmit} id="teacher-form">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
            ...
            <ul className="text-xs text-blue-500 mt-1 list-disc list-inside space-y-0.5">
              <li>Use a unique email not used before</li>
              <li>Strong password: uppercase + lowercase + number + special character</li>
              <li>Select at least one subject from the list</li>
            </ul>
          </div>
            ...
            <div className="flex justify-between flex-wrap gap-4 mt-3">
              ...
              <div className="flex flex-col gap-2 w-full md:w-1/4">
                <label className="text-xs text-gray-500">
                  Subjects *{" "}
                  <span className="text-blue-400">(hold Ctrl to select multiple)</span>
                </label>
                <select
                  multiple
                  className="ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm w-full"
                ...
                {errors.subjects?.message ? (
                  ...
                  <p className="text-xs text-gray-400">At least one subject must be selected</p>
                )}
              </div>
        ...
        >
          {isSubmitting ? (
            <>
              ...
              {type === "create" ? "Creating Teacher..." : "Updating Teacher..."}
            </>
          ) : (
